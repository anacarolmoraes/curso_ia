...
# Dados extraídos do arquivo BO_3948_11-05-2026.md
data = [
    {
...
# Cabeçalhos
headers = ["Nome", "Cargo", "Matrícula", "Data Publicação", "Itinerário", "Período", "Qtd Diárias", "Total Diária", "Processo SEI"]
ws.append(headers)
...
for index, row in df.iterrows():
    row_data = [
        row["Nome"], row["Cargo"], row["Matricula"], row["Data Publicacao"],
...
column_widths = [45, 35, 12, 18, 50, 25, 12, 15, 18]
